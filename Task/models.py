...
class Task(models.Model):
    repo = models.ForeignKey('Repository', on_delete=models.CASCADE)  # Repository表 id
    member = models.ForeignKey('Member', on_delete=models.CASCADE)  # Member表 id
...
class Record(models.Model):
    ...
    checkMember = models.ForeignKey('Member', on_delete=models.CASCADE)  # Member表 id
